        ...
        <div className="w-full bg-[#F7EED9] py-16 px-6 lg:px-20">
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
                ...
                <div className="w-full lg:w-1/2 border-2 border-[#DAA520] rounded-xl p-6 md:p-8 flex flex-col gap-4 font-sans bg-transparent">
                    <p
                        className="text-black font-bold not-italic"
                        style={{
                            fontFamily: '"Wulkan Display Bold", sans-serif',
                            fontSize: '36px',
                            lineHeight: '32px'
                        }}
                    >
                    ...
                    <button className="bg-[linear-gradient(90deg,_#C18C2C_0%,_#FCF38A_50.52%,_#C18C2C_100%)] text-[#16171d] font-semibold text-[15px] px-6 py-3 rounded-full cursor-pointer hover:opacity-90 transition-opacity w-fit self-center cursor-pointer">
                        Learn More →
                    </button>
                </div>
            </div>
